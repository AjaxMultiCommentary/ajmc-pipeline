...
def simple_coordinates_based_evaluation(gt_words: List['TextElement'],
    ...
    for gt_word in gt_words:
        ...
        for i, pred_word in enumerate(pred_words_):
            if is_rectangle_partly_within_rectangle(pred_word.coords, gt_word.coords, overlap_threshold) and \
                    is_rectangle_partly_within_rectangle(gt_word.coords, pred_word.coords, overlap_threshold):
...
def coord_based_page_evaluation(gt_page: 'Page',
    ...
    for gt_word in gt_page.words:
        ...
        for i, pred_word in enumerate(pred_words_):
            if is_rectangle_partly_within_rectangle(pred_word.coords, gt_word.coords, word_overlap_threshold) and \
                    is_rectangle_partly_within_rectangle(gt_word.coords, pred_word.coords, word_overlap_threshold):
