"""Compare canonical generated ocr-gt-lines of PD commentaries with the lines in git (GT-commentaries-ocr)"""
import os
import unicodedata
...
if __name__ == '__main__':
    git_gt_dir = None  # ENTER YOUR PATH HERE
    check_dir = None  # ENTER YOUR PATH HERE
