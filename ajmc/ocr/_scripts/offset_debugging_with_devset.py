...
from ajmc.ocr.pytorch.data_processing import TorchTrainingDataset, TorchBatchedTrainingDataset, get_custom_dataloader
...
for _ in range(1):
    ...
    for dataset_dir in DATASETS_DIR.glob('*'):
        ...
        dataset = TorchBatchedTrainingDataset(source_dir=dataset_dir,
