# This is a mere copy of HF's example (examples/pytorch/language-modeling/run_mlm.py) with some modifications.
#!/usr/bin/env python
# coding=utf-8
...
import math
import os
# We add this for testing purposes
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(
            ...
            cache_dir=model_args.cache_dir,
            token=model_args.token,
            encoding='utf-8'  # 🚧 we need to specify the encoding for txt files
        )
