...
raw_path = Path('/Users/sven/Desktop/data/agoraclass/data/corpus.txt')
cleaned_path = raw_path.parent / 'corpus_cleaned.txt'

text = raw_path.read_text(encoding='utf-8')
text = text.replace("Itinera Electronica: Du texte ŕ l'hypertexte", '')
text = text.replace("Itinera ElectronicaDu texte ŕ l'hypertexte", '')
text = re.sub(r'Derničre mise ŕ jour :.*?\n', '\n', text)
text = re.sub(r'\|.*?\n', '', text)
