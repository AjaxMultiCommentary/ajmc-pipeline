...
from commons.miscellaneous import lazy_property, RectangleType, get_custom_logger
...
class Image:
    ...
    def __init__(self, path: Optional[str] = None, matrix: Optional[np.ndarray] = None):
